...
$File = "C:\Install\Matrix\Matrix.ps1"
$Matrix | Out-File -FilePath $File -ErrorAction SilentlyContinue
powershell -nologo -executionpolicy bypass -noprofile -file $File